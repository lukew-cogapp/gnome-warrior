...
function drawLute(ctx: DrawCtx<Palette>): void {
  ...
  p.noStroke();
  p.fill(c.luteDark);
  p.ellipse(0, 0, 96, 110);
  p.fill(c.lute);
  p.ellipse(-2, -2, 88, 102);
  p.fill(c.luteDark);
  p.circle(0, 0, 20);
  p.fill(c.trim);
  p.circle(0, 0, 16);
  ...
  p.noStroke();
  p.fill(c.luteDark);
  p.rect(-8, -120, 16, 70, 3);
  p.fill(c.lute);
  p.rect(-6, -118, 12, 66, 2);
  p.stroke(c.trim);
  p.strokeWeight(1);
...
function drawBody(ctx: DrawCtx<Palette>): void {
  ...
  p.ellipse(18, 90, 38, 70);
  p.fill(c.pantHi);
  p.ellipse(-22, 80, 14, 30);
  p.ellipse(14, 80, 14, 30);
  p.fill(c.boot);
  p.rect(-30, 130, 26, 24, 4);
  p.rect(4, 130, 26, 24, 4);
  ...
  p.push();
  p.translate(20, 20);
  p.rotate(p.radians(-25 + luteTilt));
  drawLute(ctx);
  p.pop();
  ...
  p.rotate(p.radians(headTilt));
  p.fill(c.tunicHi);
  p.ellipse(0, 4, 130, 24);
  p.fill(c.tunic);
  p.ellipse(0, 0, 130, 18);
  p.fill(c.tunic);
  p.beginShape();
  p.vertex(-30, 0);
  ...
  p.beginShape();
  p.vertex(0, 0);
  p.bezierVertex(-6, -30, 14, -50, 24, -60);
