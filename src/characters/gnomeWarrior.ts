import { belt, squintEyes, stockyLegs } from '../helpers';
...
const PALETTES: readonly Palette[] = [
  {
    // classic red hat
    skin: PALETTE.skinWarm,
    skinShade: PALETTE.skinWarmShade,
    beard: PALETTE.beard,
    beardShade: PALETTE.beardShade,
    tunic: '#5a3a2a',
    tunicHi: '#7a4f3a',
    belt: '#2a1c14',
    buckle: PALETTE.gold,
